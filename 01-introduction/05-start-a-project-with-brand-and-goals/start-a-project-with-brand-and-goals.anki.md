...
```mermaid
flowchart TD
    G[Goals] --> BM[Business / Monetization]
    G --> BE[Behavioral<br/>download · buy · subscribe]
    G --> UX[User Experience<br/>devices · accessibility · usability]
    G --> CT[Context<br/>how / where users arrive]
```
![](images/start-a-project-with-brand-and-goals-card-2.png)
...
```mermaid
flowchart LR
    Center([Clean & Simple<br/>— the default]) --> F[Fancy / Luxury]
    Center --> FR[Friendly / Casual]
    Center --> Q[Quirky]
