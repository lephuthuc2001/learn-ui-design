...
```mermaid
graph TD
    A[Designing Above Your Level] --> B[1. Fail Left,<br/>Fail Right]
    A --> C[2. Julie's Method]
    A --> D[3. Sleep On It]
    B --> B1[Explore the extremes<br/>to find the acceptable range]
    C --> C1[Try every variation<br/>you can think of]
    D --> D1[Come back the next day<br/>with fresh eyes]
```
...
```mermaid
graph LR
    A[Too Small<br/>~24px] --- B[Acceptable Range<br/>30–50px] --- C[Too Big<br/>100px]
